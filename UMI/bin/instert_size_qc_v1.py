...
def plot_curve(file1, file2, outfile, sample, label1, label2):
    #print(whole)
    #print(ydata[0])
    ...
    #plt.plot(range(len(xdata3)), ydata3, label="KAPA")
...
if __name__ == '__main__':
    ...
    #t.deploy()
    #画图
    plot_curve(o.file1, o.file2, o.png, o.sample, o.label1, o.label2)
