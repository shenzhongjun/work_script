...
"""
批量刷出多个样本的shell并投递运行
从fasta原始数据开始，Call变异软件选择Mutect2和VarScan，注释软件待定（VEP或xxx）
"""
...
/mnt/share03/tumor_pipeline/Somatic/DNA/Pipeline/Somatic_V1/software/bwa mem \\
    ...
    | /mnt/share01/tools/bin/sambamba view -S -f bam -t 16 - \\
    | /mnt/share01/tools/bin/sambamba sort -t 24 -m 10G \\
    --tmpdir=tmp -u -o {tumor}.sorted.bam -
